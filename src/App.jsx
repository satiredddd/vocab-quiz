...
const QUESTIONS_SET_7 = [
  {
    term: "A psychologist studying Judy's blood-injection-injury phobia refuses to explain it using only biology. Instead, the psychologist considers her behavior, emotional reactions, social experiences, biological responses, and developmental history together. Which approach is being used?",
    choices: {
      A: 'One-dimensional model',
      B: 'Multidimensional integrative approach',
      C: 'Classical categorical approach',
  ...
  {
    term: 'A researcher argues that a psychological disorder should be explained entirely by one factor, such as a biological abnormality, without considering behavior, emotions, or social influences. Which model does this represent?',
    choices: {
      A: 'Multidimensional integrative approach',
      B: 'Diathesis-stress model',
      C: 'One-dimensional model',
      D: 'Gene-environment correlation model',
    },
    correct: 'C',
  },
  {
    term: 'Judy watches a movie involving blood and experiences a strong reaction. Later, she experiences a similar reaction when confronted with blood-related situations and even the words “Cut it out!” Which process described in the chapter helps explain why her reaction extends to similar stimuli?',
    choices: {
  ...
  {
    term: "Judy's heart rate and blood pressure initially increase when she sees blood, but then her blood pressure suddenly drops, reducing blood flow to her brain and causing her to lose consciousness. What does the chapter call this response?",
    choices: {
  ...
  {
    term: 'A person with a blood-injection-injury phobia learns to tense the muscles in the legs and arms when exposed to blood, helping prevent the sudden drop in blood pressure that could cause fainting. Which part of the multidimensional explanation is being demonstrated?',
    choices: {
      A: 'Biological and behavioral interaction',
      B: 'Cultural influence only',
      C: 'Genetic determination only',
      D: 'Cognitive unconsciousness',
    },
    correct: 'A',
  },
  {
    term: 'Researchers observe that the same psychological experience can produce different outcomes depending on when it occurs during development. Which concept from the chapter is most relevant?',
    choices: {
      A: 'Critical period',
      B: 'Reuptake',
      C: 'Gene dominance',
  ...
  {
    term: "A researcher explains that a person's characteristics are influenced by many genes rather than by a single gene. Which term from the chapter best fits this explanation?",
    choices: {
      A: 'Polygenic',
      B: 'Recessive',
      C: 'Dominant',
  ...
  {
    term: 'A child inherits a genetic condition involving changes in a specific gene, and the condition eventually produces progressive neurological problems. The chapter uses which disorder as an example of a genetic disorder?',
    choices: {
      A: 'Phenylketonuria',
  ...
  {
    term: "A child has phenylketonuria, but the harmful effects can be reduced when the child's diet is carefully controlled. What does this example demonstrate?",
    choices: {
      A: 'Genes always determine behavior regardless of environment',
      B: 'Environmental intervention can affect the expression of a genetic vulnerability',
      C: 'Psychological disorders are entirely social',
      D: 'Recessive genes cannot be influenced by the environment',
    },
    correct: 'B',
  },
  {
    term: 'A student argues, “Everything about behavior comes from genes.” Another student responds, “Everything comes from upbringing.” The chapter suggests that both statements are incomplete because behavior results from interactions between biological and environmental influences. Which issue is being illustrated?',
    choices: {
  ...
  {
    term: "A researcher examines how many genes contribute to a person's cognitive abilities rather than searching for one gene responsible for intelligence. Which field is particularly relevant?",
    choices: {
  ...
  {
    term: 'A scientist examines DNA using technology that can identify patterns of gene activity across many genes at once. Which approach from the chapter is being used?',
    choices: {
  ...
  {
    term: 'Researchers discover that environmental experiences can cause certain genes to become more or less active without changing the underlying DNA sequence. Which concept does this illustrate?',
    choices: {
      A: 'Epigenetics',
      B: 'Gene dominance',
  ...
  {
    term: 'Rat pups receive different amounts of maternal licking and grooming. Later, the pups differ in their stress responses because of changes involving glucocorticoid receptors. Which idea from the chapter does this finding support?',
    choices: {
      A: 'Early environmental experience can influence genetic expression and stress sensitivity',
      B: 'Genes are unaffected by experience',
      C: 'Psychological development ends in childhood',
      D: 'All behavior is learned through direct reinforcement',
    },
    correct: 'A',
  },
  {
    term: 'A researcher estimates the extent to which differences in a characteristic within a population can be attributed to genetic differences. Which concept is being examined?',
    choices: {
      A: 'Heritability',
      B: 'Vulnerability',
      C: 'Gene dominance',
  ...
  {
    term: 'A researcher finds that identical twins do not always both develop the same psychological disorder. What does this finding demonstrate?',
    choices: {
      A: 'Genetic factors can never influence psychological disorders',
      B: 'Genetic influence does not mean complete genetic determination',
      C: 'Environmental factors are irrelevant',
      D: 'Psychological disorders are always learned',
    },
    correct: 'B',
  },
  {
    term: 'Researchers studying schizophrenia find that even identical twins do not show 100% concordance for the disorder. Which conclusion is most consistent with the chapter?',
    choices: {
      A: 'Genetic contributions exist, but other factors also matter',
      B: 'Schizophrenia is entirely caused by environment',
      C: 'Schizophrenia is entirely caused by one gene',
      D: 'Genetics has no relationship to schizophrenia',
    },
    correct: 'A',
  },
  {
    term: 'Researchers search for specific locations on chromosomes that may be associated with psychological disorders. Which research strategy are they using?',
    choices: {
      A: 'Linkage studies',
      B: 'Modeling',
      C: 'Classical conditioning',
  ...
  {
    term: 'A person inherits a vulnerability toward depression but does not develop the disorder until experiencing significant stress. Which model best describes this situation?',
    choices: {
      A: 'Diathesis-stress model',
      B: 'Classical categorical model',
      C: 'One-dimensional model',
  ...
  {
    term: 'A person has a biological vulnerability but remains psychologically healthy because the relevant stressor never occurs. In the diathesis-stress model, what does the inherited vulnerability represent?',
    choices: {
      A: 'Stress',
      B: 'Diathesis',
      C: 'Reuptake',
  ...
  {
    term: 'A person carries a vulnerability toward a disorder but requires a particular environmental stressor before the vulnerability contributes to psychopathology. What does the chapter call the inherited susceptibility?',
    choices: {
      A: 'Vulnerability',
      B: 'Affect',
      C: 'Mood',
  ...
  {
    term: 'Judy has a biological tendency to faint when her blood pressure suddenly drops. She also has a psychological fear of blood. The chapter uses this type of interaction to demonstrate that biological and psychological factors can contribute together. Which model best captures this?',
    choices: {
      A: 'Diathesis-stress model',
      B: 'Supernatural tradition',
      C: 'Humanistic model',
      D: 'Classical conditioning alone',
    },
    correct: 'A',
  },
  {
    term: "A person has a genetic vulnerability toward alcoholism and repeatedly enters environments in which alcohol use is common. The person's genetic vulnerability makes exposure to the stressor or relevant environment more likely. Which model fits this situation?",
    choices: {
  ...
  {
    term: 'Researchers study 847 people in New Zealand and examine whether stressful life events interact with genetic differences involving serotonin transmission. Which study from the chapter is being described?',
    choices: {
      A: 'Caspi et al. (2003)',
      B: 'Kilpatrick et al. (2007)',
      C: 'Yeh, Fricke, & Edwards (1996)',
      D: 'Levy et al. (2002)',
    },
    correct: 'A',
  },
  {
    term: 'In the Caspi et al. study, people with a particular serotonin transporter genetic makeup were especially vulnerable to depression following several stressful life events. What does this demonstrate?',
    choices: {
  ...
  {
    term: 'A person with the SS version of the serotonin transporter gene experiences four or more stressful events and is more likely to develop major depression than a person with the LL version. What is this finding primarily illustrating?',
    choices: {
      A: 'Genetic vulnerability interacting with stress',
      B: 'Social stigma',
      C: 'Classical conditioning',
      D: 'Tend and befriend',
    },
  ...
  {
    term: 'Researchers studying adults after Florida hurricanes find that strong social support protects genetically vulnerable individuals from PTSD. Which study is this?',
    choices: {
      A: 'Caspi et al. (2003)',
      B: 'Kilpatrick et al. (2007)',
      C: 'Cameron et al. (2005)',
      D: 'Berton et al. (2006)',
    },
    correct: 'B',
  },
  {
    term: 'Children who were maltreated were more likely to show violent and antisocial behavior when they also had a particular genetic makeup. Which study discussed this finding?',
    choices: {
      A: 'Caspi et al. (2002)',
      B: 'Levy et al. (2002)',
      C: 'Rescorla (1988)',
      D: 'Williams et al. (1980)',
    },
    correct: 'A',
  },
  {
    term: 'A researcher studies neurons, neurotransmitters, brain circuits, and nervous-system functioning to understand psychological disorders. Which field is being used?',
    choices: {
      A: 'Neuroscience',
      B: 'Cognitive science',
      C: 'Humanistic psychology',
  ...
  {
    term: 'A neurotransmitter is released by one neuron and travels across a small gap before affecting another neuron. What is the gap called?',
    choices: {
      A: 'Synaptic cleft',
      B: 'Cerebral cortex',
      C: 'Brain stem',
  ...
  {
    term: 'A drug attaches to a receptor and produces an effect similar to the neurotransmitter normally acting at that receptor. Which term applies?',
    choices: {
      A: 'Antagonist',
      B: 'Agonist',
      C: 'Reuptake',
  ...
  {
    term: 'A drug blocks or reduces the effect of a neurotransmitter at its receptor. Which term applies?',
    choices: {
      A: 'Agonist',
      B: 'Antagonist',
      C: 'Reuptake',
  ...
  {
    term: 'A drug produces an effect opposite to that normally produced by a neurotransmitter at a receptor. Which term from the chapter applies?',
    choices: {
      A: 'Inverse agonist',
      B: 'Antagonist',
      C: 'Reuptake',
  ...
  {
    term: 'After a neurotransmitter has been released into the synaptic cleft, it is transported back into the neuron that released it. Which process is occurring?',
    choices: {
      A: 'Reuptake',
      B: 'Gene expression',
      C: 'Modeling',
  ...
  {
    term: 'A researcher studies a chemical messenger that carries signals between neurons and influences psychological functioning. Which term applies?',
    choices: {
      A: 'Neurotransmitter',
      B: 'Hormone',
      C: 'Gene',
  ...
  {
    term: 'A neurotransmitter generally reduces activity in the postsynaptic neuron and decreases arousal. Which neurotransmitter is being described?',
    choices: {
      A: 'Dopamine',
      B: 'GABA',
      C: 'Glutamate',
  ...
  {
    term: 'A neurotransmitter is described as helping turn on brain circuits and playing an important role in reward and addiction. Which neurotransmitter is being described?',
    choices: {
      A: 'Serotonin',
      B: 'GABA',
      C: 'Dopamine',
  ...
  {
    term: "During an emergency, a person's brain activates systems that produce alarm reactions and prepare the body for action. Which neurotransmitter is especially associated with this response?",
    choices: {
      A: 'GABA',
      B: 'Serotonin',
      C: 'Norepinephrine',
  ...
  {
    term: 'A neurotransmitter is being studied because it influences information processing and helps moderate or inhibit behavior. Which neurotransmitter is being discussed?',
    choices: {
      A: 'Dopamine',
      B: 'Serotonin',
      C: 'Glutamate',
  ...
  {
    term: 'A researcher studies the ancient part of the brain involved in movement, breathing, and sleeping. Which structure is being examined?',
    choices: {
      A: 'Frontal lobe',
      B: 'Cerebral cortex',
      C: 'Brain stem',
  ...
  {
    term: 'A researcher studies an area containing part of the reticular activating system that also coordinates movement with sensory output. Which structure is being examined?',
    choices: {
      A: 'Brain stem',
      B: 'Midbrain',
      C: 'Frontal lobe',
  ...
  {
    term: 'A researcher examines the part of the brain that makes up more than 80% of the neurons in the central nervous system and gives humans distinctive qualities. Which structure is being described?',
    choices: {
      A: 'Brain stem',
      B: 'Midbrain',
      C: 'Cerebral cortex',
  ...
  {
    term: 'A researcher examines brain areas involved in memory, thinking, reasoning, and the complex abilities that make humans highly social animals. Which structure is most relevant?',
    choices: {
      A: 'Frontal lobe',
      B: 'Brain stem',
      C: 'Midbrain',
  ...
  {
    term: 'Two groups of rhesus monkeys are raised in nearly identical conditions, except that one group has control over access to toys and food treats. Later, the groups respond differently to an inverse agonist affecting GABA. Which study is being described?',
    choices: {
      A: 'Insel, Scanlan, Champoux, & Suomi (1988)',
      B: 'Yeh, Fricke, & Edwards (1996)',
      C: 'Greenough et al. (1990)',
      D: 'Berton et al. (2006)',
    },
    correct: 'A',
  },
  {
    term: 'In the rhesus monkey experiment, monkeys with little control over their environment crouch in a corner and show severe anxiety and panic after receiving the drug. What does this demonstrate?',
    choices: {
      A: 'Psychological and environmental history can affect the action of a neurochemical',
      B: 'Neurotransmitters always have identical effects',
      C: 'Genes completely determine emotional responses',
      D: 'Social experience has no biological consequences',
    },
    correct: 'A',
  },
  {
    term: 'In the same experiment, monkeys that had greater control over their environment appeared angry and aggressive and attacked nearby monkeys. What does this contrast demonstrate?',
    choices: {
      A: 'The same neurochemical level can have different effects depending on psychological and environmental history',
      B: 'Anxiety is always caused by GABA',
      C: 'Aggression is entirely genetic',
      D: 'Environmental experience cannot affect brain function',
    },
    correct: 'A',
  },
  {
    term: 'In crayfish, serotonin makes certain neurons more likely to fire in a dominant animal but less likely to fire in a loser. Which study produced this finding?',
    choices: {
      A: 'Yeh, Fricke, & Edwards (1996)',
      B: 'Caspi et al. (2003)',
      C: 'Seligman & Maier (1976)',
      D: 'Rescorla (1988)',
    },
    correct: 'A',
  },
  {
    term: 'A crayfish that previously lost a social contest later becomes dominant. The effects of serotonin on its neurons change again. What does this finding demonstrate?',
    choices: {
      A: 'Changes associated with social experience can be reversible',
      B: 'Neurotransmitter effects are permanently fixed',
      C: 'Social experience has no effect on neurons',
      D: 'Only genetic changes affect neurons',
    },
    correct: 'A',
  },
  {
    term: 'A study finds that early stressful experiences produce deficits in serotonin and other neuroendocrine changes in genetically susceptible primates, but these changes do not occur without the early stress. Which researcher is associated with this finding?',
    choices: {
      A: 'Suomi',
      B: 'Rescorla',
      C: 'Lazarus',
  ...
  {
    term: 'Smaller mice that are repeatedly bullied by larger mice begin avoiding all mice and become reclusive. Researchers find changes in the mesolimbic dopamine system. Which study is this?',
    choices: {
      A: 'Berton et al. (2006)',
      B: 'Greenough et al. (1990)',
      C: 'Caspi et al. (2002)',
      D: 'Levy et al. (2002)',
    },
    correct: 'A',
  ...
  {
    term: 'The mesolimbic dopamine system is ordinarily associated with reward and addiction, but bullying causes it to contribute to avoidance and isolation. What does this demonstrate?',
    choices: {
      A: 'Psychological experience can change the usual functioning of a brain system',
      B: 'Dopamine has only one possible effect',
      C: 'Bullying has no biological effects',
      D: 'Brain circuits cannot change',
    },
    correct: 'A',
  },
  {
    term: 'Researchers discover that glucocorticoid receptors on dopaminergic neurons help facilitate and maintain social aversion following bullying. What does this finding illustrate?',
    choices: {
      A: 'Interaction between psychological experience and biological functioning',
      B: 'Purely cognitive processing',
  ...
  {
    term: 'Rats raised in an environment requiring learning and motor behavior develop more connections between nerve cells in the cerebellum and more dendrites than rats living like “couch potatoes.” Which study is being described?',
    choices: {
      A: 'Greenough et al. (1990)',
      B: 'Wallace et al. (1992)',
      C: 'Kolb, Gibb, & Gorny (2003)',
      D: 'Suomi (2000)',
    },
    correct: 'A',
  },
  {
    term: 'Researchers find that structural brain changes in rats begin after only four days in a richer environment. What concept does this finding demonstrate?',
    choices: {
      A: 'Enormous plasticity of the nervous system',
  ...
  {
    term: 'A person learns new skills and experiences changes in neural connections even later in life. Which idea from the chapter is most relevant?',
    choices: {
      A: 'Brain structure and function can change through learning and experience throughout life',
      B: 'Brain development ends during childhood',
      C: 'Genes cannot be influenced by experience',
      D: 'Neurotransmitter effects never change',
    },
    correct: 'A',
  },
  {
    term: 'Monkeys living in larger social groups show increased gray matter in brain areas involved in interpreting facial expressions and gestures and predicting what others might do. What does this demonstrate?',
    choices: {
      A: 'Social experience can affect brain structure',
      B: 'Social experience has no biological consequences',
      C: 'Brain structure is determined entirely before birth',
      D: 'Social behavior is unrelated to neuroscience',
    },
    correct: 'A',
  },
  {
    term: 'Researchers find that larger Facebook networks are correlated with increased gray matter density in several temporal lobe regions. What limitation does the chapter emphasize?',
    choices: {
      A: 'The finding is correlational',
      B: 'The finding proves Facebook causes brain growth',
      C: 'The finding proves genetics has no role',
      D: 'The finding demonstrates classical conditioning',
    },
    correct: 'A',
  },
  {
    term: 'A researcher studies how people acquire information, process it, and store and retrieve it, including memory. Which field is being used?',
    choices: {
      A: 'Cognitive science',
      B: 'Neuroscience',
      C: 'Psychoanalysis',
  ...
  {
    term: 'Two animals receive the same number of metronome-meat pairings. One animal receives meat only after the metronome, while the other receives meat both after the metronome and at other times. The second animal learns that the metronome is less meaningful. Which researcher used this example to demonstrate the importance of cognitive processes in conditioning?',
    choices: {
      A: 'Rescorla',
      B: 'Bandura',
      C: 'Seligman',
  ...
  {
    term: 'A researcher concludes that simply pairing two events in time is not sufficient for classical conditioning because judgments and cognitive processes influence learning. Which finding is being illustrated?',
    choices: {
      A: "Rescorla's work on classical conditioning",
  ...
  {
    term: 'Animals repeatedly receive foot shocks that they cannot control. Eventually, they stop trying to escape even when escape becomes possible. Which concept is being demonstrated?',
    choices: {
  ...
  {
    term: "In Seligman and Maier's research, animals that could press a lever to avoid shocks continued to function normally. What distinguished these animals from those that became helpless?",
    choices: {
      A: 'Their behavior could affect the outcome',
      B: 'They had different genes',
      C: 'They had no fear response',
      D: 'They received more shocks',
    },
    correct: 'A',
  },
  {
    term: 'A person experiences repeated uncontrollable stress and comes to believe that there is little he or she can do about the situation. According to later work based on learned helplessness, what may contribute to depression?',
    choices: {
      A: "The person's attribution that he or she has no control",
      B: 'Prepared learning',
      C: 'Modeling',
      D: 'Implicit memory',
    },
  ...
  {
    term: 'A person maintains an upbeat attitude despite stressful circumstances and shows better psychological and physical functioning. Which concept from the chapter fits?',
    choices: {
      A: 'Learned optimism',
      B: 'Learned helplessness',
      C: 'Negative affect',
  ...
  {
    term: 'People aged 50 to 94 who had positive views of themselves and aging lived an average of 7.5 years longer than those without such positive views. Which study is being described?',
    choices: {
      A: 'Levy et al. (2002)',
      B: 'Caspi et al. (2003)',
      C: 'Seligman & Maier (1976)',
  ...
  {
    term: 'Researchers investigate the factors that account for positive attitudes and happiness rather than focusing only on psychological disorders. Which field is being described?',
    choices: {
  ...
  {
    term: 'Karen observes that every time Tyrone behaves well at lunch, the teacher praises him. Karen then changes her own behavior because she wants the same praise. Which process is being demonstrated?',
    choices: {
      A: 'Modeling',
      B: 'Learned helplessness',
      C: 'Prepared learning',
  ...
  {
    term: 'A person learns a behavior by observing another person rather than through direct personal experience. Which concept applies?',
    choices: {
      A: 'Modeling',
      B: 'Prepared learning',
      C: 'Learned helplessness',
  ...
  {
    term: 'According to Bandura, behavior results from the convergence of behavior, cognitive factors, and environmental influences. Which approach does this support?',
    choices: {
      A: 'Social learning',
      B: 'One-dimensional modeling',
      C: 'Supernatural tradition',
      D: 'Classical categorical approach',
    },
    correct: 'A',
  },
  {
    term: 'A researcher studies social learning together with genetic and biological bases of social behavior. Which field described in the chapter integrates these areas?',
    choices: {
  ...
  {
    term: 'A child becomes frightened of snakes even though the child knows that the particular snake being observed is harmless. Which concept helps explain why certain objects are more readily associated with fear?',
    choices: {
      A: 'Prepared learning',
      B: 'Learned helplessness',
      C: 'Modeling',
  ...
  {
    term: 'A person is more easily frightened by a snake or spider than by a rock or flower, even when the person knows the snake or spider is harmless. What does this pattern illustrate?',
    choices: {
      A: 'Prepared learning',
      B: 'Learned optimism',
      C: 'Classical conditioning',
  ...
  {
    term: 'Researchers suggest that humans may have evolved a preparedness to fear snakes and spiders because these objects posed survival threats to ancestral humans. Which explanation does this represent?',
    choices: {
      A: 'Prepared learning',
      B: 'Modeling',
      C: 'Learned helplessness',
  ...
  {
    term: 'Research finds that females may be particularly sensitive to snakes and spiders as early as 11 months of age. What does this finding help explain?',
    choices: {
      A: 'The greater frequency of adult female snake and spider phobias',
      B: 'The development of learned helplessness',
      C: 'The effects of social isolation',
      D: 'The effects of stigma',
    },
    correct: 'A',
  },
  {
    term: 'A person becomes sick after drinking cheap wine and quickly develops an aversion to that wine after only one experience. Why does the chapter use this example?',
    choices: {
      A: 'Some associations can be learned very quickly because they have natural consequences',
      B: 'All learning requires repeated reinforcement',
      C: 'Learning cannot occur after one experience',
      D: 'Social modeling is necessary for learning',
    },
    correct: 'A',
  },
  {
    term: 'Greg fell into a lake as a baby and almost drowned. He has no conscious recollection of the event but strongly dislikes being around large bodies of water. Which concept best fits?',
    choices: {
      A: 'Implicit memory',
      B: 'Explicit memory',
      C: 'Modeling',
  ...
  {
    term: 'A person performs a behavior based on a past event but cannot consciously remember the event itself. Which type of memory is involved?',
    choices: {
      A: 'Implicit memory',
      B: 'Explicit memory',
      C: 'Learned optimism',
  ...
  {
    term: 'A person can consciously remember a past event and describe it accurately. Which type of memory is being demonstrated?',
    choices: {
      A: 'Explicit memory',
      B: 'Implicit memory',
      C: 'Prepared learning',
  ...
  {
    term: "Anna O. experiences occasional paralysis that is connected to memories of her father's death, although the connection is not initially conscious. Which concept from the chapter helps explain this?",
    choices: {
      A: 'Implicit memory',
      B: 'Prepared learning',
      C: 'Learned helplessness',
  ...
  {
    term: 'A researcher uses a color-naming task in which words are printed in different colors. Participants are slower when the meaning of the word attracts their attention. Which paradigm is being used?',
    choices: {
      A: 'Stroop color-naming paradigm',
      B: 'Learned helplessness paradigm',
      C: 'Classical conditioning paradigm',
      D: 'Tend and befriend paradigm',
    },
    correct: 'A',
  },
  {
    term: 'Judy is slower to name the colors of disorder-related words such as “blood,” “injury,” and “dissect” than unrelated words. What does this finding illustrate?',
    choices: {
      A: 'Disorder-related information can attract attention and interfere with processing',
      B: 'Prepared learning eliminates attention',
      C: 'Social relationships determine memory',
      D: 'Explicit memory is impossible',
    },
    correct: 'A',
  },
  {
    term: 'A person performs behavior based on information being processed without conscious awareness. Which view of the unconscious is consistent with modern cognitive science in the chapter?',
    choices: {
      A: 'Information can be processed, stored, and acted on without awareness',
      B: 'The unconscious is necessarily a seething caldron of id, ego, and superego conflicts',
      C: 'Conscious awareness is required for all psychological processing',
      D: 'Unconscious processes do not influence behavior',
    },
    correct: 'A',
  },
  {
    term: 'A young man has part of his visual cortex removed and reports that he cannot see, yet he can accurately reach toward objects and distinguish between them. Which phenomenon does this illustrate?',
    choices: {
      A: 'Blindsight',
      B: 'Implicit memory',
      C: 'Prepared learning',
  ...
  7: { label: "Page 7: Questions 1–83", questions: QUESTIONS_SET_7 },
};
